    ...
    <div className="wrapper-header">
      <div className="header-offer">
        <div className="header-left">
          <a>
            <img src="../img/header/logo.png" className="logo" height={"40"} width={"40"} />
          </a>
        ...
        <div className="header-right">
          <div className="inner-right">
            <button onClick={toggleDrawer} className="basket-button">
              <img src="../img/header/basket.svg" height={"18"} width={"18"} />
              <span>
          ...
          <button onClick={toggleFavorite} className="bookmark-button">
            <img src="../img/header/bookmark.svg" height={"20"} width={"20"} />
          </button>
          <button className="user-button">
            <img src="../img/header/user.svg" height={"20"} width={"20"} />
          </button>
        </div>
      </div>
      </div>
